...
path = "/tmp/pycharm_project_723/model_outputs/"
...
def SHAP_underSmapling( target,title,max_depth,n_esti,withexperience = False, color='YlGnBu'):
    matrics = []
    seed(2145)
    ...
    for train_idx, test_idx in gss.split(X, y, groups):
        ...
        mats = Make_Confusion_Matrix(cm, roc=auc, categories=categories, cmap=color, title=title, group_names=labels,
...
# #
# matrics_xgb = SHAP_underSmapling('STSRCHOSPD', 'STSRCHOSPD under sampling with experience',1,300,color='RdPu')
# matrics_xgb_df = pd.DataFrame(matrics_xgb)
# matrics_xgb_df.loc['Mean'] = matrics_xgb_df.mean()
# matrics_xgb_df.loc['Std'] = matrics_xgb_df.std()
# print(matrics_xgb_df)
...
# #
# matrics_xgb = SHAP_underSmapling('STSRCHOSPD', 'STSRCHOSPD under sampling without experience',1,300,True,color='RdPu')
# matrics_xgb_df = pd.DataFrame(matrics_xgb)
# matrics_xgb_df.loc['Mean'] = matrics_xgb_df.mean()
# matrics_xgb_df.loc['Std'] = matrics_xgb_df.std()
# print(matrics_xgb_df)
...
def SHAP_Iterates_scalePosW( target,title,withexperience = False, color='YlGnBu'):
    matrics = []
    seed(2145)
    groups = df_model_draft['HospID']
    if withexperience is False:
...
# # #
# matrics_xgb,title = SHAP_Iterates_scalePosW('STSRCOM', 'STSRCOM scale_pos_weight without experience',True)
# matrics_xgb_df = pd.DataFrame(matrics_xgb)
# print(title)
# print(matrics_xgb_df)
# # matrics_xgb_df.to_csv("/tmp/pycharm_project_723/model_outputs/STSRCOM scale_pos_weight without experience.csv")
# # #
# matrics_xgb,title = SHAP_Iterates_scalePosW('STSRCHOSPD', 'STSRCHOSPD scale_pos_weight with experience',color='RdPu')
# matrics_xgb_df = pd.DataFrame(matrics_xgb)
# print(title)
# print(matrics_xgb_df)
# # matrics_xgb_df.to_csv("/tmp/pycharm_project_723/model_outputs/SSTSRCHOSPD scale_pos_weight with experience.csv")
# #
# matrics_xgb,title = SHAP_Iterates_scalePosW('STSRCHOSPD', 'STSRCHOSPD scale_pos_weight without experience',True,color='RdPu')
# matrics_xgb_df = pd.DataFrame(matrics_xgb)
# print(title)
# print(matrics_xgb_df)
...
# # matrics_xgb = SHAP_Iterates_SVMSMOTE('STSRCOM', 'STSRCOM SVMSMOTE with experience',18,200,0.1)
# # matrics_xgb_df = pd.DataFrame(matrics_xgb)
# # matrics_xgb_df.loc['Mean'] = matrics_xgb_df.mean()
# # matrics_xgb_df.loc['Std'] = matrics_xgb_df.std()
# # print(matrics_xgb_df)
...
#
# matrics_xgb,title = SHAP_Iterates_SVMSMOTE('STSRCOM', 'STSRCOM SMOTE without experience',26,100,0.1,True)
# matrics_xgb_df = pd.DataFrame(matrics_xgb)
# print(title)
# print(matrics_xgb_df)
# # matrics_xgb_df.to_csv("/model_outputs/STSRCOM SVMSMOTE without experience.csv")
# #
# # matrics_xgb = Retrain_Model_10_Iterates_SVMSMOTE('STSRCHOSPD', 'STSRCHOSPD SVMSMOTE with experience',18,180,0.1,color='RdPu')
# # matrics_xgb_df = pd.DataFrame(matrics_xgb)
# # matrics_xgb_df.loc['Mean'] = matrics_xgb_df.mean()
# # matrics_xgb_df.loc['Std'] = matrics_xgb_df.std()
# # print(matrics_xgb_df)
...
# #
# matrics_xgb,title = SHAP_Iterates_SVMSMOTE('STSRCHOSPD', 'STSRCHOSPD SMOTE without experience',18,500,0.01,True,color='RdPu')
# matrics_xgb_df = pd.DataFrame(matrics_xgb)
# print(title)
# print(matrics_xgb_df)
...
# matrics_xgb,title = SHAP_underSmapling('Complics', 'Complics under sampling with experience',2,500,color='YlGn_r')
# matrics_xgb_df = pd.DataFrame(matrics_xgb)
# # matrics_xgb_df.loc['Mean'] = matrics_xgb_df.mean()
# # matrics_xgb_df.loc['Std'] = matrics_xgb_df.std()
# print(title)
...
# # matrics_xgb_df.to_csv("/tmp/pycharm_project_723/model_outputs/STSRCHOSPD under sampling with experience.csv")
# #
# matrics_xgb,title = SHAP_underSmapling('Complics', 'Complics under sampling without experience',1,300,True,color='YlGn_r')
# matrics_xgb_df = pd.DataFrame(matrics_xgb)
# print(title)
# print(matrics_xgb_df)
# # matrics_xgb_df.to_csv("/tmp/pycharm_project_723/model_outputs/STSRCHOSPD under sampling without experience.csv")
#
#
# matrics_xgb,title = SHAP_Iterates_scalePosW('Complics', 'Complics scale_pos_weight without experience',True,color='YlGn_r')
# matrics_xgb_df = pd.DataFrame(matrics_xgb)
# print(title)
# print(matrics_xgb_df)
# # matrics_xgb_df.to_csv("/tmp/pycharm_project_723/model_outputs/STSRCOM scale_pos_weight without experience.csv")
# # #
# matrics_xgb,title = SHAP_Iterates_scalePosW('Complics', 'Complics scale_pos_weight with experience',color='YlGn_r')
# matrics_xgb_df = pd.DataFrame(matrics_xgb)
# print(title)
# print(matrics_xgb_df)
