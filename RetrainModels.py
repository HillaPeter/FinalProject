...
# print ("yaara")
# matrics_xgb = Retrain_Model_10_Iterates_underSmapling('STSRCOM', 'STSRCOM under sampling with experience',2,200)
...
#
# matrics_xgb = Retrain_Model_10_Iterates_underSmapling('STSRCOM', 'STSRCOM under sampling without experience',2,500,True)
# matrics_xgb_df = pd.DataFrame(matrics_xgb)
# matrics_xgb_df.loc['Mean'] = matrics_xgb_df.mean()
# matrics_xgb_df.loc['Std'] = matrics_xgb_df.std()
# print(matrics_xgb_df)
...
#
# matrics_xgb = Retrain_Model_10_Iterates_underSmapling('STSRCHOSPD', 'STSRCHOSPD under sampling with experience',1,300,color='RdPu')
# matrics_xgb_df = pd.DataFrame(matrics_xgb)
# matrics_xgb_df.loc['Mean'] = matrics_xgb_df.mean()
# matrics_xgb_df.loc['Std'] = matrics_xgb_df.std()
# print(matrics_xgb_df)
...
#
# matrics_xgb = Retrain_Model_10_Iterates_underSmapling('STSRCHOSPD', 'STSRCHOSPD under sampling without experience',1,300,True,color='RdPu')
# matrics_xgb_df = pd.DataFrame(matrics_xgb)
# matrics_xgb_df.loc['Mean'] = matrics_xgb_df.mean()
# matrics_xgb_df.loc['Std'] = matrics_xgb_df.std()
# print(matrics_xgb_df)
...
# matrics_xgb = Retrain_Model_10_Iterates_SVMSMOTE('STSRCOM', 'STSRCOM SVMSMOTE with experience',18,200,0.1)
# matrics_xgb_df = pd.DataFrame(matrics_xgb)
# matrics_xgb_df.loc['Mean'] = matrics_xgb_df.mean()
# matrics_xgb_df.loc['Std'] = matrics_xgb_df.std()
# print(matrics_xgb_df)
...
matrics_xgb = Retrain_Model_10_Iterates_SVMSMOTE('STSRCOM', 'STSRCOM SVMSMOTE without experience',26,100,0.1,True)
matrics_xgb_df = pd.DataFrame(matrics_xgb)
matrics_xgb_df.loc['Mean'] = matrics_xgb_df.mean()
matrics_xgb_df.loc['Std'] = matrics_xgb_df.std()
print(matrics_xgb_df)
matrics_xgb_df.to_csv("/tmp/pycharm_project_723/model_outputs/STSRCOM SVMSMOTE without experience.csv")
...
matrics_xgb = Retrain_Model_10_Iterates_SVMSMOTE('STSRCHOSPD', 'STSRCHOSPD SVMSMOTE without experience',18,500,0.01,True,color='RdPu')
matrics_xgb_df = pd.DataFrame(matrics_xgb)
matrics_xgb_df.loc['Mean'] = matrics_xgb_df.mean()
matrics_xgb_df.loc['Std'] = matrics_xgb_df.std()
print(matrics_xgb_df)
matrics_xgb_df.to_csv("/tmp/pycharm_project_723/model_outputs/STSRCHOSPD SVMSMOTE without experience.csv")