...
def choose_script(model):
    if model == '1':
        print("model without experience with scale pos STSRCHOSPD")
        print("--------------------------------------------------------------------")
        counter = Counter(y)
    ...
    if model == '2':
        print("model without experience with undersampling STSRCHOSPD")
        print("--------------------------------------------------------------------")
        counter = Counter(y)
        # estimate scale_pos_weight value
        estimate = counter[0] / counter[1]
    ...
    if model == '5':
        print("model without experience with Smote STSRCHOSPD")
        print("--------------------------------------------------------------------")
        counter = Counter(y)
        # estimate scale_pos_weight value
        estimate = counter[0] / counter[1]
