...
def hyper_paramytize_optimization(f):
    print ("model with experience with scale pos  STSRCOM", file = f)
    print ("--------------------------------------------------------------------", file = f)
    counter = Counter(y)
...
def hyper_paramytize_optimization_under(f):
    print ("model with experience with  under sampling STSRCOM", file = f)
    print ("--------------------------------------------------------------------", file = f)
    counter = Counter(y)
    # estimate scale_pos_weight value
    estimate = counter[0] / counter[1]
...
def hyper_paramytize_optimization_Smote(f):
    print ("model with experience with Smote STSRCOM", file = f)
    print ("--------------------------------------------------------------------", file = f)
    counter = Counter(y)
    # estimate scale_pos_weight value
    estimate = counter[0] / counter[1]
...
def choose_script(model):
    if model == '1':
        name = path + "grid search stsrcom with experience scale pos.txt"
        print(name)
        f = open(name, 'w')
        hyper_paramytize_optimization(f)
        f.close()
    if model == '2':
        name = path + "test grid search stsrcom with experience under sampling.txt"
        print(name)
        f = open(name, 'w')
        hyper_paramytize_optimization_under(f)
        f.close()
    if model == '3':
        name = path + "test grid search stsrcom with experience SMOTE.txt"
        print(name)
        f = open(name, 'w')
