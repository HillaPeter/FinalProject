...
def choose_script(model):
    if model == '1':
        print("model with experience with scale pos Complics")
        print("--------------------------------------------------------------------")
        counter = Counter(y)
    ...
    if model == '2':
        print("model with experience with undersampling Complics")
        print("--------------------------------------------------------------------")
        counter = Counter(y)
        # estimate scale_pos_weight value
        estimate = counter[0] / counter[1]
    ...
    if model == '5':
        print("model with experience with Smote Complics")
        print("--------------------------------------------------------------------")
        counter = Counter(y)
        # estimate scale_pos_weight value
        estimate = counter[0] / counter[1]
        ...
        max_depths = [2, 3, 5, 8, 10, 14, 18,22]
        param_grid = {'xgbclassifier__max_depth': max_depths}
        cv = StratifiedKFold(n_splits=5)
