...
N_split=5
df_all = pd.read_csv("/tmp/pycharm_project_723/Reop_data_for_model.csv")
...
path = "/tmp/pycharm_project_723/Reop_data_for_model/"
...
def SHAP_underSmapling( target,title,max_depth,n_esti,lr,withexperience = False, color='YlGnBu'):
    matrics = []
    seed(2145)
...
#
# matrics_xgb,title = SHAP_underSmapling('STSRCOM', 'Reop STSRCOM under sampling with experience',1,200,0.1)
# print (title)
...
#
# matrics_xgb,title = SHAP_underSmapling('STSRCHOSPD', 'Reop STSRCHOSPD under sampling with experience',1,400,0.05,color='RdPu')
# print (title)
# matrics_xgb_df = pd.DataFrame(matrics_xgb)
# print (matrics_xgb_df)
...
#
matrics_xgb,title = SHAP_Iterates_SVMSMOTE('STSRCOM', 'STSRCOM SMOTE with experience',1,100,0.01)
matrics_xgb_df = pd.DataFrame(matrics_xgb)
print(title)
print(matrics_xgb_df)

matrics_xgb,title = SHAP_Iterates_SVMSMOTE('STSRCHOSPD', 'STSRCHOSPD SMOTE with experience',1,100,0.01,color='RdPu')
matrics_xgb_df = pd.DataFrame(matrics_xgb)
print(title)
print(matrics_xgb_df)
...
#
# matrics_xgb,title = SHAP_underSmapling('Complics', 'Complics under sampling with experience',1,300,0.05,color='YlGn_r')
# matrics_xgb_df = pd.DataFrame(matrics_xgb)
# print(title)
# print(matrics_xgb_df)
...
matrics_xgb,title = SHAP_Iterates_SVMSMOTE('Complics', 'Complics SMOTE with experience',1,300,0.01,color='YlGn_r')
matrics_xgb_df = pd.DataFrame(matrics_xgb)
print(title)
print(matrics_xgb_df)
